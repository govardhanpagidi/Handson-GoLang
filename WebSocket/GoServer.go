...
func echo(w http.ResponseWriter, r *http.Request) {
	c, err := connectionUpgrader.Upgrade(w, r, nil)
	if err != nil {
	...
	for {
		messageType, message, error := c.ReadMessage()
		if error != nil {
		...
		error = c.WriteMessage(messageType, []byte (val))
		if error != nil {
...
var homeTemplate = template.Must(template.New("ServerIndex").Parse(`
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
